...
RESULT_AUTOWAH  autowah_setup(AUTOWAH * c,
                              float depth,
                              float decay,
                              float audio_sample_rate);

RESULT_AUTOWAH    autowah_modify_decay(AUTOWAH * c, 
                                       float decay_new);

RESULT_AUTOWAH    autowah_modify_depth(AUTOWAH * c, 
                                       float depth_new);

RESULT_AUTOWAH    autowah_modify_q(AUTOWAH * c, 
                                   float q_new);

void    autowah_read(AUTOWAH * c,
                     float * audio_in,
                     float * audio_out,
