...
RESULT_FLANGER  flanger_modify_rate(STEREO_FLANGER * c,
                                    float new_rate_hz);

RESULT_FLANGER  flanger_modify_depth(STEREO_FLANGER * c, 
                                     float new_depth);

RESULT_FLANGER  flanger_modify_feedback(STEREO_FLANGER * c, 
                                        float new_feedback);
