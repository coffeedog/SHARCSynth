 ...
 */
RESULT_FLANGER  flanger_setup(STEREO_FLANGER * c,
                              float depth,
                              float rate_hz,
                              float feedback,
    ...
    variable_delay_setup(&c->var_del_right, 
                         depth, 
                         feedback, 
                         rate_hz,
                         audio_sample_rate,
 ...
 */
void    flanger_read(STEREO_FLANGER * c,
                     float * audio_in, 
    ...
    variable_delay_read(&c->var_del_left, 
                        audio_in, 
                        audio_out_left, 
                        lfo_left,
                        audio_block_size);
    variable_delay_read(&c->var_del_right, 
                        audio_in, 
                        audio_out_right, 
                        lfo_right,
                        audio_block_size);
