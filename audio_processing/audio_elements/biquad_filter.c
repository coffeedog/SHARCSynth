...
static RESULT_BIQUAD filter_generate_coeffs(BIQUAD_FILTER_TYPE filter_type,
                                            ...
                                            float * result );
static RESULT_BIQUAD convert_coeffs(float * coeffs_ab,
                                    float * sos_coeffs,
 ...
 */
RESULT_BIQUAD   filter_setup(BIQUAD_FILTER * c,
...
void    filter_read(BIQUAD_FILTER * c,
                    float * audio_in,
                    float * audio_out,
...
static RESULT_BIQUAD filter_generate_coeffs(BIQUAD_FILTER_TYPE filter_type,
    ...
    if (filter_type <= (int) BIQUAD_TYPE_NOTCH ) {
        switch (filter_type) {
            ...
            case BIQUAD_TYPE_LPF:   result[COEFF_B0] =  (1.0 - c_omega)*0.5;
            ...
            case BIQUAD_TYPE_HPF:   result[COEFF_B0] =  (1.0 + c_omega)*0.5;
                                    result[COEFF_B1] =  -(1.0 + c_omega);
                                    result[COEFF_B2] =  result[COEFF_B0];
                                    result[COEFF_A0] =  (1.0 + alpha);
                                    result[COEFF_A1] =  ncos2;
            ...
            case BIQUAD_TYPE_BPF:   result[COEFF_B0] =  (alpha);
                                    result[COEFF_B1] =  0;
                                    result[COEFF_B2] =  (-result[COEFF_B0]);
                                    result[COEFF_A0] =  (1.0 + alpha);
                                    result[COEFF_A1] =  ncos2;
            ...
            case BIQUAD_TYPE_NOTCH: result[COEFF_B0] =  (1.0);
        ...
        switch (filter_type)
        {
            case BIQUAD_TYPE_PEAKING:               result[COEFF_B0] =  1.0 + alpha*A;
            ...
            case BIQUAD_TYPE_L_SHELF:               result[COEFF_B0] =  A*( (A+1) - (A-1)*c_omega + sqrt_a_2*alpha );
                                                    result[COEFF_B1] =  2.0*A*((A-1)-(A+1)*c_omega);
                                                    result[COEFF_B2] =  A*( (A+1) - (A-1)*c_omega - sqrt_a_2*alpha );
            ...
            case BIQUAD_TYPE_H_SHELF:               result[COEFF_B0] =  A*( (A+1) + (A-1)*c_omega + sqrt_a_2*alpha );
                                                    result[COEFF_B1] =  2.0*A*((A-1)+(A+1)*c_omega);
                                                    result[COEFF_B2] =  A*( (A+1) + (A-1)*c_omega - sqrt_a_2*alpha );
                                                    result[COEFF_A0] =  ((A+1) - (A-1)*c_omega + sqrt_a_2*alpha);
                                                    result[COEFF_A1] =  -2.0 * ((A-1) - (A + 1)* c_omega);
...
void    filter_transition_coeffs(BIQUAD_FILTER * c) {
    ...
    if (update_coeffs) {
        ...
        filter_generate_coeffs(c->filter_type, c->freq, c->q, c->gain_db, c->audio_sample_rate, coeffs_ab);
