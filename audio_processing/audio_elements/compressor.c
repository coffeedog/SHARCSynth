 ...
 */
RESULT_COMPRESSOR compressor_setup(COMPRESSOR * c,
                                   float threshold_db,
                                   float ratio,
                                   float attack_ms,
                                   float release_ms,
    ...
    // Set output gain
    if (output_gain > COMPRESSOR_MAX_GAIN ||
            output_gain < COMPRESSOR_MIN_GAIN) {
 ...
 * @return  Compressor result (enumeration)
 */
RESULT_COMPRESSOR   compressor_modify_ratio(COMPRESSOR * c,
                                            float ratio_new) {
 ...
 * @return Compressor result (enumeration)
 */
RESULT_COMPRESSOR   compressor_modify_attack(COMPRESSOR * c,
                                             float attack_ms_new) {
 ...
 * @return Compressor result (enumeration)
 */
RESULT_COMPRESSOR   compressor_modify_gain(COMPRESSOR * c,
                                           float gain_new) {
 ...
 */
void    compressor_read(COMPRESSOR * c,
                         float * audio_in,
                         float * audio_out,
