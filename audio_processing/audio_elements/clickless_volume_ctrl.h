...
typedef enum
{
    VOLUME_OK,
    VOLUME_INVALID_GAIN,
    VOLUME_INVALID_INSTANCE_POINTER
} RESULT_VOLUME_CTRL;
...
extern "C" {
#endif
RESULT_VOLUME_CTRL  volume_control_setup(VOLUME_CTRL * C,
                                         float initial_gain);

RESULT_VOLUME_CTRL  volume_control_set_gain(VOLUME_CTRL * C,
                                            float new_gain,
                                            VOLUME_CTRL_TRANSITION_SPEED speed);

void    volume_control_read(VOLUME_CTRL * c,
                            float * audio_in,
                            float * audio_out,
